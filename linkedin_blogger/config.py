...
# The nudge cadence is the posting interval (POST_INTERVAL_DAYS / the owner's setting), so a
# single "post every N days" control governs both spacing and reminders.
